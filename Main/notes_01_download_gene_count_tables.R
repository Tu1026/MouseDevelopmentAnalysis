...
# AM: Check doesn't work - already had one file downloaded as demo
# Call doesn't work - must include () on function calls
...
# AM: Doesn't work - load tools library
# Need consistency in args (leave a space) and assignment ( <- )
# Naming doesn't work - assume fb_gene_ex is full of NAs bc not downloaded
# This error propagates to following steps
...
# AM: looks like you are using different variable names, for one
# Consider using vector check: == is for one element
